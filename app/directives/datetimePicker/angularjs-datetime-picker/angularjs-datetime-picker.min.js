(function() {
    ...
    var tmpl = require('./angularjs-datetime-picker.html');
    ...
    var datetimePickerPopup = function($locale, dateFilter) {
        ...
        var initVars = function() {
            ...
            for (var i = 0; i < 7; i++) { //jshint ignore:line
                ...
                daysOfWeek.push({
                    fullName: day,
                    firstLetter: day.substr(day.length - 1, 2)
        ...
        var getMonthView = function(year, month) {
            ...
            console.log('zzw', 'fd:' + firstDayOfMonth, 'ld:' + lastDayOfMonth,
                'ldp:' + lastDayOfPreviousMonth, 'di:' + daysInMonth, 'dil:' + daysInLastMonth,
                'dw:' + dayOfWeek, 'lead:' + leadingDays, 'fdw' + firstDayOfWeek);
        ...
        var linkFunc = function(scope, element, attrs, ctrl) { //jshint ignore:line
            ...
            scope.updateNgModel = function(day) {
                ...
                scope.selectedDate = new Date(
                    scope.mv.year, scope.mv.month, day, scope.inputHour, scope.inputMinute, scope.inputSecond
                );
                scope.selectedDay = scope.selectedDate.getDate();
                if (attrs.ngModel) {
                    ...
                    if (attrs.ngModel) {
                        elScope[attrs.ngModel] = dateValue;
                    }
                }
            };
